...
import dev.t3d.happraisal.api.controller.InterviewController;
...
public class InterviewEntityControllerITest {
  ...
  void should_create_interview() throws Exception {
    // given
    var interviewToSave = getInterview(Optional.empty());
    var interviewSaved =
        getInterview(Optional.of(UUID.fromString("b9bd9655-d423-4900-8b12-8dc83d3ff94d")));
  ...
  private Interview getInterview(Optional<UUID> id) {
