...
class PostInterviewSTestEntity extends AbstractIntegrationTestWithDatabase {
  ...
  void should_create_interview() throws JsonProcessingException {
    var manager =
        new PersonEntity(UUID.fromString("8a37adbc-0c29-491a-8b6f-f10a4219fb91"), null, null, true);
    var employee =
        new PersonEntity(
            UUID.fromString("3556c835-3bcd-420e-bb6e-a8b7c0bb139d"), null, null, false);
    var form =
        new FormEntity(UUID.fromString("df9b2aad-d32e-469e-b434-be71a5531a35"), new HashSet<>());
    var interview = new InterviewEntity(null, Instant.now(), manager, employee, form);
